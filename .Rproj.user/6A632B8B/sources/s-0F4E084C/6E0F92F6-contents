...
#### Output data ####
write.csv(train_oversampled, 'data/trainDataOversampled_featEng_v1.csv', row.names=FALSE)
write.csv(test, 'data/testDataOversampled_featEng_v1.csv', row.names=FALSE)