...
# split the data into test and train sets using cDP func
...
#### Output data ####
write.csv(train_int, 'data/trainData_FEng_cDP_int_v1.csv', row.names=FALSE)
write.csv(test_int, 'data/testData_FEng_cDP_int_v1.csv', row.names=FALSE)

write.csv(train_num, 'data/trainData_FEng_cDP_num_v1.csv', row.names=FALSE)
write.csv(test_num, 'data/testData_FEng_cDP_num_v1.csv', row.names=FALSE)
